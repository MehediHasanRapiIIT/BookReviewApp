            ...
            <div class="col-md-12">
                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        ...
                        @else
                            <img src="https://placehold.co/990x1400?text=No+Image & font=roboto" alt="" class="card-img-top">
                        @endif
                    </div>
                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-4 col-lg-4 mb-4">
                                        <div class="card border-0 shadow-lg">
                                            ...
                                            @if($relatedBook->image != "")
                                                <img src="{{ asset('uploads/books/thumb/' . $relatedBook->image) }}" alt=""
                                                    class="card-img-top">
                                            @else
                                                <img src="https://placehold.co/990x1400?text=No+Image & font=roboto" alt=""
                                                    class="card-img-top">
                                            @endif
                                            </a>
                                            <div class="card-body">
                                                <h3 class="h4 heading">
                                                    <a href="{{ route('book.details', $relatedBook->id) }}">{{ $relatedBook->title }}</a></h3>
